...
consus-launcher/
  ...
  LICENSE
```
Keep the Rust side small enough to read in one sitting. Target: about 1,500 lines of app code (`#[cfg(test)]` modules excluded). This is a guideline, not a hard limit (decided 2026-09-24): keep code tight, but going past it does not block a change.
...
- ~~No Pi.~~ Reversed 2026-09-24: Pi is a launcher tool.
